...
NOTE: The filter hook list has been temporarily removed in order to reduce the readme.txt size, which caused some problems with how it is displayed on wordpress.org.
